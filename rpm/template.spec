...
Name:           ros-noetic-gmcl
Version:        1.0.1
Release:        3%{?dist}%{?release_suffix}
Summary:        ROS gmcl package
...
based localization technique for mobile robots in 2D-known map. It integrates
the adaptive monte carlo localization - amcl - approach with three different
particle filter algorithms (Optimal, Intelligent, Self-adaptive) to improve the
performance while working in real time. Main node structure and amcl-
algorithms’s code was derived, with thanks, from Brian Gerkey's amcl package.
...
%changelog
* Thu Jul 15 2021 Mhd Ali Alshikh Khalil <adler1994@gmail.com> - 1.0.1-3
- Autogenerated by Bloom

* Thu Jul 15 2021 Mhd Ali Alshikh Khalil <adler1994@gmail.com> - 1.0.1-2
- Autogenerated by Bloom

* Thu Jul 08 2021 Mhd Ali Alshikh Khalil <adler1994@gmail.com> - 1.0.1-1
- Autogenerated by Bloom
