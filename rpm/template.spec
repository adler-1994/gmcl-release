...
the adaptive monte carlo localization - amcl - approach with 3 particle filter
algorithms (Optimal, Intelligent, Self-adaptive) to improve the performance of
amcl while working in real time. Main node structure and amcl-algorithms’s code
was derived, with thanks, from Brian Gerkey's amcl package.
